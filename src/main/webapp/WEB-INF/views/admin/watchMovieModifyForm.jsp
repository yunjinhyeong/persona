...
<body>
	...
	<jsp:include page="/WEB-INF/views/include/sidebarForAdmin.jsp" />
        <div class="main_content">
            <form action="/watchMovie/modify" method="post" name="frm">
                <input type="hidden" name="pageNum" value="${ pageNum }">
                <input type="hidden" name="num" value="${ watchMovieVo.num }">
                <Table class="addMovieMain">
                    <tr>
                        <tr>
                            <th><label for="name">영화제목</label></th>
                            <td><input type="text" name="name" value="${ watchMovieVo.name }" required></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="datetime-local" name="date" value="${ watchMovieVo.date }" required></td>
                        </tr>
                        <tr>
